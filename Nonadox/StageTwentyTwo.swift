...
class StageTwentyTwo: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        brain.setLocation()
        brain.levelNumber(levelNum: 22, nextNum: 23)
        brain.setDirections(direct:[[1,1],[1,0,1],[0,1,2],[2,0,0,1],[0,1,1,1],[0,0,1,0],[0,0,0,2],[1,0,0,1],[0,0,2,2]])
        brain.setScore(gold: 14, silver: 17, bronze: 20)
        brain.winningCondition(winState:[2,0,2,2,2,1,1,0,2])
        brain.load()
