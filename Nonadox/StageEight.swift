...
class StageEight: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        brain.setLocation()
        brain.levelNumber(levelNum: 8, nextNum: 9)
        brain.setDirections(direct:[[1,1],[0,1,1],[0,2,1],[2,1,0,0],[1,0,0,1],[0,1,1,1],[1,0,0,2],[0,0,1,1],[0,0,2,0]])
        brain.setScore(gold: 6, silver: 9, bronze: 12)
        brain.winningCondition(winState:[0,1,1,2,0,1,1,2,2])
        brain.load()
