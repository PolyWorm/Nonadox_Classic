...
class StageSixteen: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        brain.setLocation()
        brain.levelNumber(levelNum: 16, nextNum: 17)
        brain.setDirections(direct:[[2,0],[0,2,1],[0,1,1],[0,0,0,1],[1,0,0,1],[0,0,2,0],[2,0,0,1],[1,0,0,2],[0,0,1,2]])
        brain.setScore(gold: 9, silver: 12 ,bronze: 15)
        brain.winningCondition(winState:[1,2,2,2,1,1,0,1,2])
        brain.load()
