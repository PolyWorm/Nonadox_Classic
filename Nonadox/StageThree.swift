...
class StageThree: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        brain.setLocation()
        brain.levelNumber(levelNum: 3, nextNum: 4)
        brain.setDirections(direct:[[1,2],[0,2,0],[0,1,2],[2,0,0,0],[0,0,0,0],[0,0,2,0],[2,0,0,1],[0,0,0,2],[0,0,1,2]])
        brain.setScore(gold: 10, silver: 13, bronze: 16)
        brain.winningCondition(winState:[2,1,1,1,1,1,1,1,2])
        brain.load()
