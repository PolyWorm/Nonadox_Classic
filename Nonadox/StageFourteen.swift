...
class StageFourteen: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        brain.setLocation()
        brain.levelNumber(levelNum: 14, nextNum: 15)
        brain.setDirections(direct:[[0,2],[1,0,0],[0,2,1],[2,0,0,1],[1,0,0,1],[0,1,1,1],[2,0,0,1],[0,0,1,0],[0,0,1,0]])
        brain.setScore(gold: 7, silver: 10, bronze: 13)
        brain.winningCondition(winState:[1,0,2,2,1,1,2,2,0])
        brain.load()
