...
class StageFifteen: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        brain.setLocation()
        brain.levelNumber(levelNum: 15, nextNum: 16)
        brain.setDirections(direct:[[0,1],[1,0,1],[0,2,0],[1,1,0,0],[0,0,0,1],[0,1,2,1],[1,0,0,2],[0,0,1,2],[0,0,2,1]])
        brain.setScore(gold: 13, silver: 16, bronze: 19)
        brain.winningCondition(winState:[0,2,1,1,1,0,1,0,0])
        brain.load()
