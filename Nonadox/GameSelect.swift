...
class GameSelect: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        let swipeLeft:UISwipeGestureRecognizer = UISwipeGestureRecognizer(target: self, action: #selector(GameSelect.swipedLeft(_:)))
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches {
            ...
            if a1button.contains(touch.location(in: self)){
                
                fadeout()
                a1button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = Tutorial(size: scene!.size)
            ...
            if a2button.contains(touch.location(in: self)) && defaults.integer(forKey: "s1") > 0{
                
                fadeout()
                a2button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageOne(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if a3button.contains(touch.location(in: self)) && defaults.integer(forKey: "s2") > 0{
                
                fadeout()
                a3button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageTwo(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if a4button.contains(touch.location(in: self)) && defaults.integer(forKey: "s3") > 0{
                
                fadeout()
                a4button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageThree(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if b1button.contains(touch.location(in: self)) && defaults.integer(forKey: "s4") > 0{
                
                fadeout()
                b1button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageFour(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if b2button.contains(touch.location(in: self)) && defaults.integer(forKey: "s5") > 0{
                
                fadeout()
                b2button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageFive(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if b3button.contains(touch.location(in: self)) && defaults.integer(forKey: "s6") > 0{
                
                fadeout()
                b3button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageSix(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if b4button.contains(touch.location(in: self)) && defaults.integer(forKey: "s7") > 0{
                
                fadeout()
                b4button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageSeven(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if c1button.contains(touch.location(in: self)) && defaults.integer(forKey: "s8") > 0{
                
                fadeout()
                c1button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageEight(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if c2button.contains(touch.location(in: self)) && defaults.integer(forKey: "s9") > 0{
                
                fadeout()
                c2button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageNine(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if c3button.contains(touch.location(in: self)) && defaults.integer(forKey: "s9") > 0{
                
                fadeout()
                c3button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageTen(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if c4button.contains(touch.location(in: self)) && defaults.integer(forKey: "s9") > 0{
                
                fadeout()
                c4button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageEleven(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if d1button.contains(touch.location(in: self)) && defaults.integer(forKey: "s9") > 0{
                
                fadeout()
                d1button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageTwelve(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if d2button.contains(touch.location(in: self)) && defaults.integer(forKey: "s9") > 0{
                
                fadeout()
                d2button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageThirteen(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if d3button.contains(touch.location(in: self)) && defaults.integer(forKey: "s9") > 0{
                
                fadeout()
                d3button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageFourteen(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if d4button.contains(touch.location(in: self)) && defaults.integer(forKey: "s9") > 0{
                
                fadeout()
                d4button.alpha = 0.2
                SKTAudio.sharedInstance().playSoundEffect("e.wav")
                let nextScene = StageFifteen(size: scene!.size)
                let wait = SKAction.wait(forDuration: 0.6)
                let block = SKAction.run({
                    nextScene.scaleMode = .aspectFill
                    let transition = SKTransition.crossFade(withDuration: 0.5)
            ...
            if right.contains(touch.location(in: self)) {
    ...
    func load(){
        ...
        switch defaults.integer(forKey: "s0"){
        ...
        switch defaults.integer(forKey: "s1"){
        ...
        switch defaults.integer(forKey: "s2"){
        ...
        switch defaults.integer(forKey: "s3"){
        ...
        switch defaults.integer(forKey: "s4"){
        ...
        switch defaults.integer(forKey: "s5"){
        ...
        switch defaults.integer(forKey: "s6"){
        ...
        switch defaults.integer(forKey: "s7"){
        ...
        switch defaults.integer(forKey: "s8"){
        ...
        switch defaults.integer(forKey: "s9"){
        ...
        switch defaults.integer(forKey: "s10"){
        ...
        switch defaults.integer(forKey: "s11"){
        ...
        switch defaults.integer(forKey: "s12"){
        ...
        switch defaults.integer(forKey: "s13"){
        ...
        switch defaults.integer(forKey: "s14"){
        ...
        switch defaults.integer(forKey: "s15"){
