...
class StageSeventeen: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        brain.setLocation()
        brain.levelNumber(levelNum: 17, nextNum: 18)
        brain.setDirections(direct:[[2,1],[0,2,0],[0,1,2],[2,1,0,0],[0,1,1,1],[0,1,2,0],[2,0,0,1],[1,0,0,2],[0,0,1,2]])
        brain.setScore(gold: 12, silver: 15, bronze: 18)
        brain.winningCondition(winState:[1,2,1,2,2,2,2,2,0])
        brain.load()
